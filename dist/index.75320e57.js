...
function handleMailLinks() {
    ...
    for (const [i, link] of emailLinkEls.entries())link.addEventListener("click", (e)=>{
    ...
    const routes = [
        {
            ...
            handler: ()=>{
                contentEl.innerHTML = "";
                contentEl?.appendChild((0, _components.createContent)("inbox", route));
            }
        },
        {
            path: /\/sent/,
            handler: ()=>{
                contentEl.innerHTML = "";
                contentEl?.appendChild((0, _components.createContent)("sent", route));
            }
        }
    ];
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createContent", ()=>createContent);
...
},{"../images/polygon-1.svg":"39Dom","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"39Dom":[function(require,module,exports) {
